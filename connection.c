...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug1) {
		debug1--;
		printf("d01: connection.default_handler() will be called from connection.call_connection_handler()\n");
	}
...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug2) {
		debug2--;
		printf("d02: connection.default_handler() will be called from connection.process_request_body()\n");
	}
...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug3) {
		debug3--;
		printf("d03: connection.call_connection_handler() will be called POINT 1 from connection.MHD_connection_handle_idle()\n");
	}
...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug4) {
		debug4--;
		printf("d04: connection.process_request_body() will be called POINT 2 from connection.MHD_connection_handle_idle()\n");
	}
...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug5) {
		debug5--;
		printf("d05: connection.call_connection_handler() will be called POINT 3 from connection.MHD_connection_handle_idle()\n");
	}
...
//*************************** MODIFIED HERE!!! ****************************
	...
	if (debug6) {
		debug6--;
		printf("d06: connection.MHD_connection_handle_idle() will be called from connection.MHD_queue_response()\n");
	}
