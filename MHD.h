...
#include <microhttpd.h>		//*************************** MODIFIED (added) SINGLE STRING HERE!!! ****************************
...
//    virtual bool run(int thread_number, Request& req, Response& resp) = 0;	
    virtual bool run(const MHD_ConnectionInfo *client_addr, int thread_number, Request& req, Response& resp) = 0;		//*************************** MODIFIED SINGLE STRING HERE!!! ****************************
